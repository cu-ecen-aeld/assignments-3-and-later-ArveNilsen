...
OUTDIR=/mnt/build-cache/tmp/aeld
...
make CONFIG_PREFIX="${OUTDIR}/rootfs" CONFIC_TC=n ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE} install
...
cd "$FINDER_APP_DIR"
make clean
make CROSS-COMPILE=${CROSS-COMPILE} writer
